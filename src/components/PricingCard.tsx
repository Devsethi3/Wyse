...
export function PricingCard({ name, description, price, features, popular = false, icon: Icon }: PricingCardProps) {
    ...
    >
      ...
      <div className="relative p-6 flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-base font-medium text-zinc-900 dark:text-zinc-100">{name}</h3>
          ...
          >
            <div
              className={cn(
                ...
                feature.highlight ? "bg-violet-100 dark:bg-violet-900/20" : "bg-zinc-100 dark:bg-zinc-800",
              )}
            >
              {feature.icon}
            </div>
